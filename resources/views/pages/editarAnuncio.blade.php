                            ...
                            <form class="submit-form" action="{{ route('cliente.postEditarAnuncio') }}" method="POST"
                                ...
                                <div class="row">
                                    <div class="col-md-12 col-lg-12 col-xs-12  col-sm-12">
                                        ...
                                        <textarea rows="4" class="form-control" name="descripcion">{{old('descripcion',$anuncio->descripcion)}}</textarea>
                                    </div>
                                </div>
                                <!-- end row -->
                                <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-lg-6 col-xs-12 col-sm-12">
                                        ...
                                        <input class="form-control" name="direccion" id="direccion" value="{{old('direccion',$anuncio->direccion)}}">
                                    </div>
                                </div>
                                {{-- <div class="row">
                                    <div class="col-md-12 col-lg-12 col-xs-12  col-sm-12">
                                ...
                                <div class="row">
                                                          ...
                                                          <div class="card">
                                                            <div class="card-body">
                                                              ...
                                                              <div id="lightgallery" class="galeria">
                                                                  ...
                                                                  <div class="opciones">
                                                                      <a href="{{url('/retirar-imagen/'.$imagen->id)}}"><i title="Retirar imagen" class="fas fa-calendar-times"></i></a>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-lg-6 col-xs-12 col-sm-12">
                                            ...
                                            <input class="form-control" value="{{old('edad',$anuncio->edad)}}" name="edad" placeholder="" type="text">
                                        </div>
                                        <div class="col-md-6 col-lg-6 col-xs-12 col-sm-12">
                                            <label class="control-label">Tu teléfono<small></small></label>
                                            <input class="form-control" value="{{old('telefono',$anuncio->telefono)}}" name="telefono" placeholder="" type="tel">
                                        </div>
                                    </div>
                                    <!-- end row -->
                                    {{-- <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-lg-6 col-xs-12 col-sm-12">
                                            ...
                                            <select class="category form-control" name="paquete_id">
                                                <option label="Select Option"></option>
                                                @foreach ($paquetes as $paquete)
                                                <option value="{{$paquete->id}}" {{ old('paquete_id', $anuncio->paquete_id) == $paquete->id ? 'selected' : '' }}>Reactivación cada {{ $paquete->periodo_horas}} horas</option>
