...
<div class="botones">
<a href="{{url('categoria/create')}}" class="btn btn-success mb-2">Registrar nueva categoría</a>
...
<th>Acciones</th>
    ...
    @foreach($categorias as $c)
        <tr>
            ...
            <td>
            <a href="{{url('/categoria/'.$c->id.'/edit')}}" id="botoncol" class="btn btn-warning mb-2 ">Editar</a>

            <form method="post" action="{{url('categoria/'.$c->id)}}" class="d-inline">
            @csrf
            {{method_field('DELETE')}}
