          ...
          <div class="row">
             ...
             <div class="header-right col-md-4 col-sm-6 col-xs-12 ">
                <div class="pull-right">
                   <ul class="listnone">
                      <li><a href=""><i class="fa fa-sign-in"></i>Iniciar sesión</a></li>
                      <li><a href=""><i class="fa fa-unlock" aria-hidden="true"></i>Registrarse</a></li>
                      <li class="dropdown">
             ...
             <div class="container">
                <div class="row">
                   <div class="col-lg-12 col-md-12">
                      ...
                      <ul class="menu-logo">
                         <li>
                            <a href="index.html"><img style="width: 100px" src="{{asset('/images/logo/logoPassionReal.jpeg')}}" alt="logo"> </a>
                         </li>
                      </ul>
                      <!-- menu links -->
                      <ul class="menu-links">
                         ...
                         <li>
                            <a href="javascript:void(0)">Categorías <i class="fa fa-angle-down fa-indicator"></i></a>
                      ...
                      <ul class="menu-search-bar">
                         <li>
                            <a href="post-ad-1.html" class="btn btn-light"><i class="fa fa-plus" aria-hidden="true"></i> Publicar anuncio</a>
                         </li>
                      </ul>
                   </div>
                </div>
